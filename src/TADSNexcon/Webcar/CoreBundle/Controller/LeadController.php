...
class LeadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TADSNexconWebcarCoreBundle:Lead')->findAll();
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TADSNexconWebcarCoreBundle:Lead')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TADSNexconWebcarCoreBundle:Lead:edit.html.twig")
     */
